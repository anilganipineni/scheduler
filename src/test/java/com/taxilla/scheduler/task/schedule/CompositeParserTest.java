...
import com.taxilla.scheduler.task.schedule.CompositeParser;
import com.taxilla.scheduler.task.schedule.Parser;
import com.taxilla.scheduler.task.schedule.Schedule;
import com.taxilla.scheduler.task.schedule.ScheduleParsersHelper.FakeParser;
...
import static com.taxilla.scheduler.task.schedule.ScheduleParsersHelper.ANY_SCHEDULE_STRING;
import static com.taxilla.scheduler.task.schedule.ScheduleParsersHelper.DAILY_AT_MIDNIGHT;
import static com.taxilla.scheduler.task.schedule.ScheduleParsersHelper.DAILY_AT_NOON;
import static com.taxilla.scheduler.task.schedule.ScheduleParsersHelper.DAILY_PARSER;
import static com.taxilla.scheduler.task.schedule.ScheduleParsersHelper.FIXED_DELAY_PARSER;
import static com.taxilla.scheduler.task.schedule.ScheduleParsersHelper.THROWING_PARSER;
import static com.taxilla.scheduler.task.schedule.ScheduleParsersHelper.assertScheduleNotPresent;
import static com.taxilla.scheduler.task.schedule.ScheduleParsersHelper.assertSchedulePresent;
