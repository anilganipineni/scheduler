...
import com.github.anilganipineni.scheduler.task.schedule.ScheduleParsersHelper.FakeParser;
...
import static com.github.anilganipineni.scheduler.task.schedule.ScheduleParsersHelper.ANY_SCHEDULE_STRING;
import static com.github.anilganipineni.scheduler.task.schedule.ScheduleParsersHelper.DAILY_AT_MIDNIGHT;
import static com.github.anilganipineni.scheduler.task.schedule.ScheduleParsersHelper.DAILY_AT_NOON;
import static com.github.anilganipineni.scheduler.task.schedule.ScheduleParsersHelper.DAILY_PARSER;
import static com.github.anilganipineni.scheduler.task.schedule.ScheduleParsersHelper.FIXED_DELAY_PARSER;
import static com.github.anilganipineni.scheduler.task.schedule.ScheduleParsersHelper.THROWING_PARSER;
import static com.github.anilganipineni.scheduler.task.schedule.ScheduleParsersHelper.assertScheduleNotPresent;
import static com.github.anilganipineni.scheduler.task.schedule.ScheduleParsersHelper.assertSchedulePresent;
...
public class CompositeParserTest {
    ...
    public void returns_schedule_from_the_first_matching_parser() {
        assertParsingResult(DAILY_AT_MIDNIGHT, MATCHING_PARSER_MIDNIGHT, MATCHING_PARSER_NOON, NON_MATCHING_PARSER);
        assertParsingResult(DAILY_AT_MIDNIGHT, MATCHING_PARSER_MIDNIGHT, NON_MATCHING_PARSER, MATCHING_PARSER_NOON);
        assertParsingResult(DAILY_AT_MIDNIGHT, MATCHING_PARSER_MIDNIGHT, THROWING_PARSER, MATCHING_PARSER_NOON);
        assertParsingResult(DAILY_AT_MIDNIGHT, NON_MATCHING_PARSER, MATCHING_PARSER_MIDNIGHT, MATCHING_PARSER_NOON);
        assertParsingResult(DAILY_AT_MIDNIGHT, NON_MATCHING_PARSER, MATCHING_PARSER_MIDNIGHT, THROWING_PARSER);
        assertParsingResult(DAILY_AT_NOON, MATCHING_PARSER_NOON, MATCHING_PARSER_MIDNIGHT, NON_MATCHING_PARSER);
        assertParsingResult(DAILY_AT_NOON, NON_MATCHING_PARSER, MATCHING_PARSER_NOON, MATCHING_PARSER_MIDNIGHT);
